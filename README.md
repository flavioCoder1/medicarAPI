...
- Template: Páginas para visualização de dados. Normalmente, é aqui que fica o HTML que será renderizado nos navegadores; (Não foi utilizada pois foi desenvolvido somente o BackEnd da aplicação.)
